...
const Integrantes: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold text-center mb-4">👥 Nossa Equipe</h1>
      <p className="text-center text-gray-600 mb-12 text-lg">Conheça os desenvolvedores por trás do Summit Consulting</p>
